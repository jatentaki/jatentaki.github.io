...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_836c2811a14e29305c7c49cf4d5cc4751ae98657": function($0) {
                Module.STDWEB.from_js($0, (function(){console.log ("Schedule is not initalized");})());
            },
            ...
            "__extjs_49e0df90b78bbee9e5a52551a24b50eb0f0be848": function($0, $1, $2, $3, $4) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);$4 = Module.STDWEB.to_js($4);Module.STDWEB.from_js($0, (function(){Module.exports.initializeSchedule = ($1); Module.exports.dijkstraPath = ($2); Module.exports.getNodes = ($3); Module.exports.initPackage = ($4);})());
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'wasm_client'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'wasm_client':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" ) {
        ...
        const wasm_path = path.join( __dirname, "wasm_client.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "wasm_client.wasm" )
